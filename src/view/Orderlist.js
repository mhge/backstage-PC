...
const fakeDataUrl = 'http://api.cat-shop.penkuoer.com/api/v1/admin/orders';
...
class Classlist extends Component {
  ...
  handleOk = e => {
    reqwest({
      url: 'http://api.cat-shop.penkuoer.com/api/v1/admin/orders/' + this.state.ids,
      method: 'delete',
      headers: { 'Accept': 'application/json', 'Authorization': 'Bearer ' + this.state.token },
      success: res => {
        console.log(res)
    ...
    return (
      ...
      <Row type="flex" justify="space-around" align="middle" style={{ height: "50px", textAlign: "center", color: "#19CAAD",fontSize:"24px" }}>
       ...
       <Row type="flex" justify="space-around" align="middle">
          <Col span={8} offset={8}>
            <DemoBox value={120}>
              <Input placeholder="请输入订单id进行搜索" allowClear onChange={this.onChange} />
            </DemoBox>
          </Col>
          <Col span={8}>
            <DemoBox value={120}>
                  ...
                  >
                    ...
                    >
                      ...
                      <Button style={{
                        ...
                        <NavLink to="/home/order/alter">修改用户</NavLink>
                      </Button>
                    </div>
                  </Drawer>
